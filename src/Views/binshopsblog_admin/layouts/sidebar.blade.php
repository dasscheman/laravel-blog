        ...
        <div>
            ...
            <div class="list-group ">
                <a href='{{ route('binshopsblog.admin.index') }}'
                   class='list-group-item list-group-color list-group-item list-group-color-action @if(\Request::route()->getName() === 'binshopsblog.admin.index') active @endif  '>
                    <i class="fa fa-th fa-fw" aria-hidden="true"></i>
                    All Posts
                </a>
                @foreach(BinshopsLanguage::where('active', true)->get() as $lang)
                    <a href='{{ route('binshopsblog.admin.create_post', ['locale' => $lang->locale]) }}'
                       class='list-group-item list-group-color list-group-item list-group-color-action'>
                        <i class="fa fa-plus fa-fw" aria-hidden="true"></i>
                        Add {{$lang->locale}} Post
                    </a>
                    @endforeach
            </div>
        </div>
