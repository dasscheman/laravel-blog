<div class='add_comment_area'>
    ...
    <form method='post' action='{{route("binshopsblog.comments.add_new_comment",[$post->slug])}}'>
        ...
        <div class="form-group ">
            <label id="comment_label" for="comment">@lang('binshop.your_comment')</label>
            <textarea
                    class="form-control"
                    name='comment'
                    required
                    id="comment"
                    placeholder="@lang('binshop.write_your_comment_here')"
        ...
        <div class='container-fluid'>
            <div class='row'>
                @if(config("binshopsblog.comments.save_user_id_if_logged_in", true) == false || !\Auth::check())
                    <div class='col'>
                        <div class="form-group ">
                            <label id="author_name_label" for="author_name">@lang('binshop.your_name')</label>
                            <input
                                    type='text'
                                    class="form-control"
                                    name='author_name'
                                    id="author_name"
                                    placeholder="@lang('binshop.your_name')"
                                    required
                    ...
                    @if(config("binshopsblog.comments.ask_for_author_email"))
                        <div class='col'>
                            <div class="form-group">
                                <label id="author_email_label" for="author_email">@lang('binshop.your_email')
                                    <small>(@lang('binshop.wont_be_displayed_publicly'))</small>
                                </label>
                                <input
                                        type='email'
                                        class="form-control"
                                        name='author_email'
                                        id="author_email"
                                        placeholder="@lang('binshop.your_email')"
                                        required
                ...
                @if(config("binshopsblog.comments.ask_for_author_website"))
                    <div class='col'>
                        <div class="form-group">
                            <label id="author_website_label" for="author_website">@lang('binshop.your_website')
                                <small>(@lang('binshop.will_be_displayed'))</small>
                            </label>
                            <input
                                    type='url'
                                    class="form-control"
